					...
					<div class="dropdown" style="display:{{ (admin_login()['role'] =='0') ? 'none' : '' }}">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="notification-list mx-h-350 customscroll">
								<ul>
									@foreach (getNotification($limit=true) as $item)
									<li>
										<a href="#">
				...
				<div class="user-info-dropdown">
					<div class="dropdown">
						<a
							...
							data-toggle="dropdown"
						>
							<span class="user-icon" style="display: none">
								{{-- <img src="{{ asset('assets/admin/') }}/vendors/images/photo1.jpg" alt="" /> --}}
							</span>
							<span class="user-name" style="padding: 15px 0;">{{admin_login()['fname'] }}</span>
						</a>
						<div
							class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list"
						>
							<a class="dropdown-item" href="{{ (admin_login()['role'] !='2') ?  url('profile') : url('userProfile') }}"
								><i class="dw dw-user1"></i> Profile</a
							>
							<a class="dropdown-item" href="{{ url('changePassword')}}"
								><i class="dw dw-password"></i> Change password</a
							>
