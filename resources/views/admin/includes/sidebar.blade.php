<div class="brand-logo">
				<a href="{{ (admin_login()['role'] !='2' ) ? url('dashboard') : url('userDashboard') }}">
					...
					<img
						src="{{ asset('assets/admin/') }}/vendors/images/deskapp-logo-white.svg"
						alt=""
						class="light-logo"
					/>
				</a>
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li>
							<a href="{{ (admin_login()['role'] !='2' ) ? url('dashboard') : url('userDashboard') }}" class="dropdown-toggle no-arrow">
						...
						<li>
							<a href="{{ url('Investment') }}" class="dropdown-toggle no-arrow">
						...
						@if(admin_login()['role'] == '2')
						<li>
							<a href="{{ url('myInvestment') }}" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-currency-dollar"></span
								><span class="mtext">My Investment</span>
							</a>
						</li>
						@endif
						{{-- <li class="dropdown">
