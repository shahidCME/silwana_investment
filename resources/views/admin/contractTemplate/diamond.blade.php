...
<body>
    ...
    <table style="width: 100%;">
        <tbody>
            ...
            <tr>
                <td style="width: 50%;">
                    <h1><b>Commercial Partnership Contract</b> </h1>
                    <p>This agreement was concluded on the ــ day of ـــ month, 2021 Between:</p>
                </td>
                <td style="width: 50%;">
                    <div style="text-align: right;" dir="rtl">
                        <h1><b>عقد شراكة تجارية</b> </h1>
                        <p>أنه في هذا اليوم ـــ من شهر ــــ من عام 2021 تم توقيع هذا العقد بين كل من:</p>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <p><b>M.</b> {{ (empty($arabic)) ? $viewData[0]->customerFname .' '.  $viewData[0]->customerLname : '' }}</p>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <h1 style="text-align: right;"><b>تمهيد</b></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (1): Illustration </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الأول: التفسير</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (2): Commercial Capital Amount </strong></h1>
                    <p style="font-size: 16px;margin-bottom:25px;">The above-mentioned Preamble shall be deemed as an integral part of this agreement and shall be read and interpreted along with it.</p>
                    <p style="font-size: 16px;margin-bottom:25px;">The second party has agreed and accepted to pay a commercial capital of {{ (empty($arabic)) ? $viewData[0]->amount : '***' }} Dirhams Emirati (ــــ Dirhams Emirati) and handed it over to the First Party which will carry on its commercial business as a producer and trader for the purpose of participating in the commercial livestock and agricultural products of Silwana Dimond pursuant to the above-mentioned preamble. And this amount will be considered as initial commercial capital and can be increased in accordance with the items regulating this matter.
                    </p>
                </td>
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الثاني: مدفوعات رأس المال التجاري</strong></h1>
                   ...
                   <p style="text-align: right;margin-bottom: 25px;" dir="rtl">وافق وقبل الطرف الثاني على شراكته التجارية بمبلغ وقدره {{ (!empty($arabic)) ? $arabic['amount'] : '***' }} ( ــــدرهم إماراتي) وسلمه للطرف الأول الذي يقوم بأداء عمله كتاجر مشاريع بغرض المشاركة في تجارة سلوانا دايموند الزراعية والحيوانية، وهذا المبلغ يعتبر كإيداع مبدئي يمكن زيادته طبقاً للبنود المنظمة لهذا الشأن.</p>
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <h1><strong>Item (3): Administration and Risk </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الثالث: الإدارة و المخاطر</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (4): Profit and Loss </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الرابع: الأرباح و الخسائر</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (5): Death Cases (Allah Forbid) </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الخامس: حالات الوفاة (لا قدر الله)</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (6): Confidentiality of Accounts</strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند السادس: سرية الحسابات</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (7): Prohibition of Competition </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند السابع: حظر المنافسة</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (8): Withdrawal and Assignment of The Commercial Partnership Contract</strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الثامن: الانسحاب و التنازل عن العقد</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (9): Termination of Contract</strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند التاسع: فسخ العقد</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (10): Expiration of the Commercial Partnership Contract </strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند العاشر: إنتهاء العقد</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>Item (11): Contract Duration</strong></h1>
                    <p style="font-size: 16px;margin-bottom:25px;">The First Party and the Second Party agreed that the period of this contract will be For One Georgian calendar year commenced from */*/2021-- and expires on */*/2022 </p>
                </td>
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الحادي عشر: مدة العقد</strong></h1>
                    <p style="text-align: right;margin-bottom: 25px;" dir="rtl">إتفق الطرفان على ان تكون مدة العقد سـنة ميلادية واحدة تبدأ من تاريخ */*/2021 وتنتهي بتاريخ */*/2022   </p>
                </td>
            </tr>

            <tr>
                <td>
                    <h1><strong>Item (12): Reports</strong></h1>
                ...
                <td>
                    <h1  style="text-align: right;"  dir="rtl"><strong>البند الثاني عشر: التقارير</strong></h1>
            ...
            <tr>
                <td>
                    <h1><strong>The First Party</strong></h1>
                    <h1><strong>Silwana Diamond Investment </strong></h1>

                    <h1 style="margin-top: 50px;"><strong>Signature / </strong></h1>

                    <h1 style="margin-top:50px"><strong>The Second Party</strong></h1>
                    <h1><strong>Mr.:  </strong></h1>

                    <h1 style="margin-top: 50px;"><strong>Signature / </strong></h1>

                    <h1 style="margin-top: 50px;"><strong>Issued on the ** day of ** Month of the Year of Two Thousand and Twenty-One </strong></h1>

                    <h1 style="margin-top: 50px;"><strong>The Date: </strong></h1>
                </td>


                <td>
                    <h1  style="text-align: right;"  dir="rtl" ><strong>الطرف الأول</strong></h1>
                    <h1 style="text-align: right;margin-bottom: 25px;" dir="rtl">شركة سلوانا دايموند للاستثمار </h1>
                    <h1 style="margin-top: 50px;"  dir="rtl"><strong>التوقيع /   </strong></h1>

                    <h1  style="text-align: right;margin-top: 50px;"  dir="rtl" ><strong>الطرف الثاني </strong></h1>
                    <h1 style="text-align: right;margin-bottom: 25px;" dir="rtl">السيد /  </h1>
                    <h1 style="margin-top: 50px;"  dir="rtl"><strong>التوقيع / </strong></h1>

                    <h1 style="margin-top: 50px;"  dir="rtl"><strong>تحرر في يومه و شهره وعامه في اليوم ** من شهر ** من عام ألفان و واحد و عشرون </strong></h1>
                    <h1 style="margin-top: 50px;"  dir="rtl"><strong>التاريخ:</strong></h1>
